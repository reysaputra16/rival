...
const CreateCompetitionPage: React.FC<{
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("/api/dashboard/create-competition", {
        method: "POST",
        body: JSON.stringify({
  ...
  // TODO: Currently the sports list cannot be saved, as the async function is not saving the list in time using the sportscheck. We need to manually add the sports name into the list every time we check it in the checkbox.
